        ...
        case 2:
            if (mainPointerId && subPointerId === event.pointerId) {
                ...
                if (mainPointer) {
                    ...
                    const distance = Math.hypot(event.offsetX - mainPointer.offsetX + event.offsetY - mainPointer.offsetY);
                    const angle = Math.acos((event.offsetX - mainPointer.offsetX) / twinDistance) * 180 / Math.PI;
